...
INSERT INTO `address` VALUES ('21', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '刘备', '13716052241', '', '北京市市辖区东城区', '棣新一路圣豪购物广场', '0', '家');
...
INSERT INTO `code` VALUES ('14', '13716052241', '3842', '1612273206389');
INSERT INTO `code` VALUES ('15', '13716052241', '6286', '1612312529670');
INSERT INTO `code` VALUES ('16', '13716052241', '3349', '1612316257524');
INSERT INTO `code` VALUES ('17', '13716052241', '3048', '1612319965104');
INSERT INTO `code` VALUES ('18', '13716052241', '4382', '1612323199309');
INSERT INTO `code` VALUES ('19', '13716052241', '8437', '1612323907922');
INSERT INTO `code` VALUES ('20', '13716052241', '9843', '1612331113303');
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('6', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '13716052241', '', '奋斗小青年', '/uploads/8dda4cf0-607b-11eb-9385-89ed0ee77cb0.png', '1', '1992-02-14', '山东省滨州市滨城区', 'it讲师', null, '1599556783839', '1');
...
CREATE TABLE `message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `desc` varchar(255) DEFAULT '' COMMENT '消息描述',
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES ('1', '好消息！好消息，今日活动礼品大放送', '1612161753362', '1');
INSERT INTO `message` VALUES ('2', '满100减30，不容错过，速来抢夺！', '1612161753364', '1');
INSERT INTO `message` VALUES ('3', '会员日，等你来哦，充2000送2000', '1612161753366', '1');
...
INSERT INTO `orders` VALUES ('247', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '159', 'sub_0_1611669134315056347', '1', '小米10', '3999.00', '/uploads/d6a0eff0-70be-11ea-91a2-9395060d7390.jpg', '2');
INSERT INTO `orders` VALUES ('248', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '160', 'sub_0_1611669827653026806', '1', '小米10', '3999.00', '/uploads/d6a0eff0-70be-11ea-91a2-9395060d7390.jpg', '1');
INSERT INTO `orders` VALUES ('249', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '161', 'sub_0_1611716010821667691', '1', '小米10', '3999.00', '/uploads/d6a0eff0-70be-11ea-91a2-9395060d7390.jpg', '3');
INSERT INTO `orders` VALUES ('250', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '162', 'sub_0_1611717324620396358', '1', '小米10', '3999.00', '/uploads/d6a0eff0-70be-11ea-91a2-9395060d7390.jpg', '3');
INSERT INTO `orders` VALUES ('251', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '162', 'sub_1_1611717324620396358', '5', '华为MateBook13', '4299.00', '/uploads/2a3e16d0-5ef6-11eb-8407-bb52993c067f.jpg', '9');
INSERT INTO `orders` VALUES ('252', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '162', 'sub_2_1611717324620396358', '6', '华为MateBook14', '5299.00', '/uploads/08188b00-5ee5-11eb-9611-cfb4d6b321e9.jpg', '1');
...
INSERT INTO `shop_order` VALUES ('159', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '23', '1611669134315056347', '', null, '7998.00', '2', '', '', '2021-01-26 21:52:14', '0');
INSERT INTO `shop_order` VALUES ('160', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '21', '1611669827653026806', '2021012622001420320501138238', '1', '3999.00', '1', '', '', '2021-01-26 22:03:47', '1');
INSERT INTO `shop_order` VALUES ('161', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '1', '1611716010821667691', '', null, '11997.00', '3', '', '', '2021-01-27 10:53:30', '0');
INSERT INTO `shop_order` VALUES ('162', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '23', '1611717324620396358', '', null, '55987.00', '13', '', '', '2021-01-27 11:15:24', '0');
...
CREATE TABLE `user_sign` (
  ...
  `days` int(10) DEFAULT NULL COMMENT '连续签到天数',
  `count_days` int(10) DEFAULT NULL COMMENT '共计签到天数',
  `last_sign_time` char(13) DEFAULT NULL COMMENT '最后一次签到时间',
  `score` int(10) DEFAULT NULL COMMENT '积分',
  `sign_nums` int(2) DEFAULT '0' COMMENT '可补签次数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户签到个人配置表';

-- ----------------------------
-- Records of user_sign
-- ----------------------------
INSERT INTO `user_sign` VALUES ('20', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', '1', '2', '1612318088290', '1', '0');
...
CREATE TABLE `user_sign_log` (
  ...
  `sign_content` text COMMENT '签到奖励内容',
  `add_time` char(13) DEFAULT NULL COMMENT '签到时间',
  `sign_type` enum('签到','补签') DEFAULT '签到' COMMENT '签到类型1=签到2=补签',
  `patch_time` char(13) DEFAULT NULL COMMENT '补签的时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户签到日志记录';

-- ----------------------------
-- Records of user_sign_log
-- ----------------------------
INSERT INTO `user_sign_log` VALUES ('22', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', null, '1612139819000', '签到', null);
INSERT INTO `user_sign_log` VALUES ('32', '6e7dd8d0-f1b4-11ea-84da-07a5d6e2f2fe', null, '1612318088290', '签到', null);
