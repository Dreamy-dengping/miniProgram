...
/***/ 41:
/*!****************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \****************************************************************************/
...
/***/ 42:
/*!*********************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/index/index.vue ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ 43:
/*!****************************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \****************************************************************************************/
...
try {
  components = {
    ...
    uCountDown: function() {
      return __webpack_require__.e(/*! import() | uview-ui/components/u-count-down/u-count-down */ "uview-ui/components/u-count-down/u-count-down").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-count-down/u-count-down.vue */ 208))
    },
    uSubsection: function() {
      return __webpack_require__.e(/*! import() | uview-ui/components/u-subsection/u-subsection */ "uview-ui/components/u-subsection/u-subsection").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-subsection/u-subsection.vue */ 215))
    },
    uLazyLoad: function() {
    ...
    uSkeleton: function() {
      return __webpack_require__.e(/*! import() | uview-ui/components/u-skeleton/u-skeleton */ "uview-ui/components/u-skeleton/u-skeleton").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-skeleton/u-skeleton.vue */ 229))
    }
  }
} catch (e) {
  if (
...
/***/ 45:
/*!**********************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default =
{
  data: function data() {
    return {
      ...
      catenav: [{ name: '推荐' }, { name: '女装' }, { name: '男装' }, { name: '鞋包' }, { name: '居家' }, { name: '母婴' }, { name: '美妆' }, { name: '手机' }, { name: '电脑' }],
      bannerlist: [], //初始化轮播图数据
      quicknav: [
  ...
  methods: {
    ...
    // 跳转到活动页面
    goActive: function goActive(e) {
      uni.navigateTo({
        url: '../active/active?data=' + JSON.stringify(this.bannerlist[e]) });
    ...
    currentChange: function currentChange(e) {
      this.current = e;
      this.shoplist = this.hortgoods[e].content;
    },
    // 获取热推商品数据
    getHortData: function getHortData() {var _this2 = this;
      this.$http({
        url: 'gethortgoods' }).

      then(function (res) {
        _this2.hortgoods = res.list;
        _this2.shoplist = _this2.hortgoods[_this2.goodsIndex].content;
      });
    },
    // 获取商品秒杀数据
    getSeckData: function getSeckData() {var _this3 = this;
      this.$http({
        url: 'getseckill' }).

      then(function (res) {
        _this3.seckill = res.list[0];
        // 处理图片路径
        _this3.seckill.img = _this3.$URL + _this3.seckill.img;
        // console.log(this.seckill.img)
        // 处理倒计时
        _this3.seckill.countTime = parseInt(_this3.seckill.endtime) / 1000 - new Date().getTime() / 1000;
      });
    },
    // 获取活动数据
    getBannerData: function getBannerData() {var _this4 = this;
      this.$http({
        url: 'getbanner' }).

      then(function (res) {
        _this4.bannerlist = res.list;
        // 处理图片路径
        _this4.bannerlist.forEach(function (item) {
          item.img = _this4.$URL + item.img;
        });
      });
    },
    // 获取分类导航数据
    getNavData: function getNavData() {var _this5 = this;
      this.$http({
        url: 'getcate' }).

      then(function (res) {
        _this5.catenav = res.list;
      });
    },
    // 切换分类导航
    changecurrent: function changecurrent(e) {var _this6 = this;
      // console.log(e)
      this.currentnav = e;
      setTimeout(function () {
        uni.navigateTo({
          url: '../goodlist/goodlist?type=1&cateid=' + _this6.catenav[e].id });
...
/***/ 47:
/*!******************************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
