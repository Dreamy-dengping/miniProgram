...
/* 0 */
/*!*******************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/main.js ***!
  \*******************************************/
...
var _config = _interopRequireDefault(__webpack_require__(/*! @/utils/config.js */ 39));
...
var _httpInterceptor = _interopRequireDefault(__webpack_require__(/*! @/utils/http.interceptor.js */ 40));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}_vue.default.use(_uviewUi.default);_vue.default.config.productionTip = false;_App.default.mpType = 'app'; // 引入网络请求方法 并挂载到原型链上
_vue.default.prototype.$http = _request.default; // 引入业务域名信息
_vue.default.prototype.$URL = _config.default;var app = new _vue.default(_objectSpread({}, _App.default)); // http拦截器，此为需要加入的内容，如果不是写在common目录，请自行修改引入路径
...
/* 5 */
/*!*******************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/App.vue ***!
  \*******************************************/
/*! no static exports found */
...
/* 6 */
/*!********************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/App.vue?vue&type=script&lang=js& ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
// 引入提示模块
var _require = __webpack_require__(/*! @/utils/tip.js */ 8),isLogin = _require.isLogin;
// 项目的根组件
var _default = {

  // 采用小程序的全局变量定义方式
  globalData: {
    loginStatus: true, //true:代表用户已经登录  false:没有登录
    userInfo: {}, //初始化用户的基本信息
    header: {
...
/* 9 */
/*!*****************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
