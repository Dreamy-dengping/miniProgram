...
/***/ 90:
/*!****************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/main.js?{"page":"pages%2Forder%2Forder"} ***!
  \****************************************************************************/
...
/***/ 91:
/*!*********************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/order/order.vue ***!
  \*********************************************************/
/*! no static exports found */
...
/* harmony import */ var _order_vue_vue_type_template_id_127632e4_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order.vue?vue&type=template&id=127632e4&scoped=true& */ 92);
...
/* harmony import */ var _order_vue_vue_type_style_index_0_id_127632e4_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./order.vue?vue&type=style&index=0&id=127632e4&scoped=true&lang=css& */ 96);
...
/***/ 92:
/*!****************************************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/order/order.vue?vue&type=template&id=127632e4&scoped=true& ***!
  \****************************************************************************************************/
...
/***/ 94:
/*!**********************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/order/order.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var app = getApp();var _default =
{
  ...
  onLoad: function onLoad(option) {
    // 获取全局数据
    var _app$globalData = app.globalData,loginStatus = _app$globalData.loginStatus,userInfo = _app$globalData.userInfo,header = _app$globalData.header;
    // 首先判断用户是否登录
    if (!loginStatus) {
      // 提示用户登录
      isLogin(app);return;
    ...
    // 获取订单数据
    var _uni$getStorageSync = uni.getStorageSync('order'),data = _uni$getStorageSync.data,countmoney = _uni$getStorageSync.countmoney,countnumber = _uni$getStorageSync.countnumber;
    this.orders = data;
  ...
  methods: {
    ...
    // 获取当前用户收货地址(首先获取默认地址（status:1）如果没有再获取其他地址(status:0))
    getAddress: function getAddress() {var _this = this;
      this.$http({
        url: 'addresslist',
        header: this.header,
        data: { uid: this.userInfo.uid, status: 1 } }).

      then(function (res) {
        if (res.code == 200) {
          if (res.list == null) {
            _this.localBuffer = false;
          } else {
            _this.localBuffer = true;
            _this.address = res.list[0];
            // 处理手机号
            _this.address.userphone = _this.address.userphone.substr(0, 3) + '****' + _this.address.userphone.substr(7);
          }
    ...
    orderadd: function orderadd() {
      ...
      then(function (res) {
        if (res.code == 200) {
          ...
          // 获取服务端返回的订单编号
          var outTradeNo = res.list.outTradeNo;
          // 如果是h5端就跳转到支付页面
...
/***/ 96:
/*!******************************************************************************************************************!*\
  !*** D:/工作/新版小U商城界面/小u商城/正式版小u商城/pages/order/order.vue?vue&type=style&index=0&id=127632e4&scoped=true&lang=css& ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
