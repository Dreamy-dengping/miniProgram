			...
			getOneAddr(){
				...
				this.$http(option).then(res=>{
					...
					if(res.data.code==200){
						...
						this.userphone=res.data.list[0].userphone;
						this.useraddress=res.data.list[0].useraddress;
						this.location=res.data.list[0].location;
						this.label=res.data.list[0].label;
						this.status=res.data.list[0].label.status==0?true:false;
					}
				})
			},
			// 提交修改
